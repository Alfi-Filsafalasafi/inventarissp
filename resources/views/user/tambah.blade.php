                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group @error('nama') has-error @enderror">
                            ...
                            <input type="text" id="name" name="nama" class="form-control" value="{{ old('nama') }}" placeholder="Masukkan nama">
                            @error('nama')
                    ...
                    <div class="col-md-6">
                        <div class="form-group @error('email') has-error @enderror">
                            ...
                            <input name="email" value="{{old('email')}}" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                            @error('email')
                            <span class="help-block">{{$message}}</span>
                            @enderror
                        </div>
